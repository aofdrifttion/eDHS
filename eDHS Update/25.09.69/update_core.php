 ...
 */
function execute_system_update($targetVersion = null, $isCli = null, $force = false) {
    ...
    if ((!$hasGit && $force) || !is_dir($patchDir)) {
        // หากไม่มีโฟลเดอร์แพตช์ในเครื่อง หรือเครื่องที่ไม่มี Git สั่งรีอัปเดต ให้ดาวน์โหลดจาก GitHub อัตโนมัติ (ไม่ต้องใช้ Git)
