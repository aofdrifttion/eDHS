...
try {
    ...
    if (file_exists($config_file)) {
        ...
        if (isset($config_data['debtor_setting']) && $config_data['debtor_setting']['enabled'] === '1') {
            ...
            $conn->query("UPDATE imr_tb_debtor_rights_opd SET original_debit = debit WHERE accountcode IN ('1102050101.203') AND original_debit IS NULL");
            $conn->query("UPDATE imr_tb_debtor_rights_opd SET debit = $amount WHERE accountcode IN ('1102050101.203')");
        }
    }
