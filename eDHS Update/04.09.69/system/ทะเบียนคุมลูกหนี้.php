                        ...
                        <div style="padding: 20px;" >
                          <div class="table-responsive">
                            <table  class="responsive-table">
                              <thead>
                                <tr>
                                  <th colspan="16" style="text-align: center;font-size: 16px; background-color: #fff;border: none;"> <?php echo $hospital; ?> ทะเบียนคุมลูกหนี้สิทธิ <span id="vtxt3"><?php $result1 = DateThaiM($gmm);echo $result1['fiscalYear']; ?></span><br>เดือน <span id="vtxt0"><?php $result1 = DateThaiM($gmm); echo $result1['fullDate']; ?></span></th>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <th style="text-align: center;width: 10%;">รายละเอียด<br>ปรับปรุง</th>
                                </tr>
                              </thead>
                              <tbody id="tt01">
