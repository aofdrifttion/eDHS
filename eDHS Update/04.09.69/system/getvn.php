                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-md-12">
                        <div class="card-body" style="height: 100vh;">
                          <iframe src="./vn.php" style="width: 100%; height: 95vh;"></iframe>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div class="modal-dialog modal-xl" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h5 class="modal-title" id="exampleModalLabel4">คำสั่งแต่งตั้งคณะกรรมการบริหารการเงินการคลัง โรงพยาบาลโพนทราย</h5>
                              <button
                                type="button"
                                class="btn-close"
