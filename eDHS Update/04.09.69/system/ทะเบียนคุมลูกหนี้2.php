     ...
     $day90=0; $adebitlast = 0;$adebitlasts = 0;$acchnlast = 0;$adebit = 0; $acolumn6 =0; $acolumn7 =0; $acolumn8 =0; $acolumn9 =0; $acolumn10 =0; $acolumn11 =0; $acolumn12 =0;$acolumn10last =0;
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        if($row["column10last"] === '0.00'){
          ...
          <td style="text-align: right;color: #0004a1;" class="numericcolor column3">' . $row["column10last"] . '</td>
          ...
          <td style="text-align: right;background: #fff3d7;" class="editable numeric column6">' . number_format(!empty($row["column6"]) ? $row["column6"] : 0, 2) . '</td>
          <td style="text-align: right;" class="numericcolor column7">' . $row["column7"] . '</td>
          <td style="text-align: right;background: #f2ffd7;" class="editable numeric column8">' . number_format(!empty($row["column8"]) ? $row["column8"] : 0, 2) . '</td>
          <td style="text-align: right;background: #f2ffd7;" class="editable numeric column9">' . number_format(!empty($row["column9"]) ? $row["column9"] : 0, 2) . '</td>

          <td style="text-align: right;background: #d7ffda;" class="editable numeric column10">' . number_format(!empty($row["column10"]) ? $row["column10"] : 0, 2) . '</td>
          <td style="text-align: right;background: #d7ffda;" class="numericcolor column11">' . $row["column11"] . '</td>

          <td style="text-align: right;" class="numericcolor column12">' . $row["column12"] . '</td>
          <td style="text-align: right;" class="editable numeric column13">' . $row["column13"] . '</td>
          <td style="text-align: right;" class="editable numeric column14">' . $row["column14"] . '</td>
          <td style="text-align: right;" class="editable numeric column15">' . $row["column15"] . '</td>
          <td style="text-align: right;" class="editable numeric column16">' . $row["column16"] . '</td>
