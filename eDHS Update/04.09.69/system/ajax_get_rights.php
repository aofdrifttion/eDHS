...
if ($is_sss_eff_ipd && $auto_split_sss_ipd) {
    $has_sss_ipd_parents = (isset($rights_map['1102050101.302']) || isset($rights_map['1102050101.304']));
...
if ($is_sss_eff_opd && $auto_split_sss_opd) {
    $has_sss_opd_parents = (isset($rights_map['1102050101.301']) || isset($rights_map['1102050101.303']) || isset($rights_map['1102050101.307']) || isset($rights_map['1102050101.308']));
