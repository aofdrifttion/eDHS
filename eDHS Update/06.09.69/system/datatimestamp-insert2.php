  ...
  if ($is_cr_child) {
      ...
      if ($q_bd && mysqli_num_rows($q_bd) > 0) {
          ...
          $success = mysqli_query($conn, "UPDATE imr_tb_debtor_cr_breakdown 
                   ...
                   WHERE visit_type = 'OPD' AND vn = '$vn'");
          if (floatval($r_bd['general_remain_amount']) <= 0) {
              mysqli_query($conn, "UPDATE imr_tb_debtor_rights_opd SET bill = '$data' WHERE vn = '$vn'");
          }
      } else {
          // รายการที่เป็น Native ใน 1102050101.216 หรือเดือนที่ไม่ได้เปิด CR Splitting
...
if(isset($_POST['billdate'])){
  ...
  if ($is_cr_child) {
      ...
      if ($q_bd && mysqli_num_rows($q_bd) > 0) {
          ...
          if (floatval($r_bd['general_remain_amount']) <= 0) {
              mysqli_query($conn, "UPDATE imr_tb_debtor_rights_opd SET billdate = '$data' WHERE vn = '$vn'");
          }
      } else {
          // รายการที่เป็น Native ใน 1102050101.216 หรือเดือนที่ไม่ได้เปิด CR Splitting
  ...
  if ($is_cr_child) {
      ...
      if ($q_bd && mysqli_num_rows($q_bd) > 0) {
          ...
          $success = mysqli_query($conn, "UPDATE imr_tb_debtor_cr_breakdown 
                   ...
                   WHERE visit_type = 'IPD' AND vn = '$vn'");
          if (floatval($r_bd['general_remain_amount']) <= 0) {
              mysqli_query($conn, "UPDATE imr_tb_debtor_rights_ipd SET bill = '$data' WHERE an = '$vn'");
          }
      } else {
          // รายการที่เป็น Native ใน 1102050101.217 หรือเดือนที่ไม่ได้เปิด CR Splitting
...
if(isset($_POST['billdate_i'])){
  ...
  if ($is_cr_child) {
      ...
      if ($q_bd && mysqli_num_rows($q_bd) > 0) {
          ...
          if (floatval($r_bd['general_remain_amount']) <= 0) {
              mysqli_query($conn, "UPDATE imr_tb_debtor_rights_ipd SET billdate = '$data' WHERE an = '$vn'");
          }
      } else {
          // รายการที่เป็น Native ใน 1102050101.217 หรือเดือนที่ไม่ได้เปิด CR Splitting
...
if (isset($_POST['action_bulk_update_bill'])) {
    ...
    if ($is_cr_child) {
        ...
        if ($typecc === 'OPD') {
            ...
            // อัปเดตตารางหลักสำหรับรายการ Native หรือรายการที่ไม่มีใน breakdown
