...
/* =========================================================================
   🌟 Modern Debtor Control Registry UI (ทะเบียนคุมลูกหนี้)
   ========================================================================= */
.recon-filter-card {
  background: #ffffff;
  border-radius: 16px;
...
.locked-cell {
            ...
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-12 mb-4">
                    ...
                    <div class="recon-card-header">
                      <div class="recon-header-left">
                        ...
                        <div>
                          ...
                          <p class="recon-header-subtitle">ทะเบียนคุมลูกหนี้สิทธิประจำเดือนและรายงานสถานะลูกหนี้</p>
                        </div>
                      </div>
                      <div>
                  ...
                  <!-- Card แสดงตารางรายงานทะเบียนคุมลูกหนี้สิทธิ -->
  ...
  <!-- Extra Large Modal for Updated Debtors -->
  <div class="modal fade" id="updated-debtors-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">📄 รายละเอียดการปรับปรุงลูกหนี้</h5>
  ...
  <!-- Modal ตรวจสอบและยันยอดบัญชี (Reconciliation Audit Center) -->
...
<script src="https://code.iconify.design/iconify-icon/1.0.7/iconify-icon.min.js"></script>
    ...
    <script>
      ...
      $('#selectTypeOpt').change(function() {
        ...
        $.ajax({
            url: 'ทะเบียนคุมลูกหนี้2.php', // ไฟล์ PHP ที่จะดึงข้อมูล
            type: 'POST',
      ...
      function fetch_text() { 
        ...
        $.ajax({
            ...
            error: function() {
                $('#updated-debtors-tbody').html('<tr><td colspan="6" class="text-center text-danger">เกิดข้อผิดพลาดในการดึงข้อมูล</td></tr>');
            }
        });
    }

        // =================================================================
        // 🛡️ RECONCILIATION AUDIT SYSTEM (ระบบตรวจสอบยันยอดบัญชี - ดูได้อย่างเดียว)
        // =================================================================
