...
/* ==========================================================================
   eDHS Premium SweetAlert2 Custom Theme
   ========================================================================== */
.swal2-container {
  z-index: 99999 !important;
  backdrop-filter: blur(5px) !important;
  -webkit-backdrop-filter: blur(5px) !important;
  background: rgba(34, 48, 62, 0.45) !important;
}

/* Modal Card */
.swal2-popup.edhs-swal-modal,
.swal2-popup {
  border-radius: 24px !important;
  padding: 2.2rem 2.25rem 2rem 2.25rem !important;
  box-shadow: 0 20px 60px rgba(15, 23, 42, 0.22), 0 0 1px rgba(0, 0, 0, 0.1) !important;
  border: 1px solid rgba(226, 232, 240, 0.8) !important;
  background: #ffffff !important;
  font-family: 'Noto Sans Thai', 'Public Sans', sans-serif !important;
...
.swal2-icon.swal2-question {
  ...
  background: linear-gradient(135deg, rgba(59, 130, 246, 0.1) 0%, rgba(37, 99, 235, 0.04) 100%) !important;
  box-shadow: 0 0 0 8px rgba(59, 130, 246, 0.08) !important;
...
.swal2-icon.swal2-success {
  ...
  background: linear-gradient(135deg, rgba(16, 185, 129, 0.1) 0%, rgba(5, 150, 105, 0.04) 100%) !important;
  box-shadow: 0 0 0 8px rgba(16, 185, 129, 0.08) !important;
  margin: 0.5rem auto 1.25rem auto !important;
}
...
.swal2-icon.swal2-warning {
  ...
  background: linear-gradient(135deg, rgba(245, 158, 11, 0.1) 0%, rgba(217, 119, 6, 0.04) 100%) !important;
  box-shadow: 0 0 0 8px rgba(245, 158, 11, 0.08) !important;
}
...
.swal2-icon.swal2-error {
  ...
  background: linear-gradient(135deg, rgba(239, 68, 68, 0.1) 0%, rgba(220, 38, 38, 0.04) 100%) !important;
  box-shadow: 0 0 0 8px rgba(239, 68, 68, 0.08) !important;
}
...
/* Confirm Button (Green Theme matching #save button) */
.edhs-swal-confirm-btn {
  background: linear-gradient(135deg, #009922 0%, #00831b 100%) !important;
  color: #ffffff !important;
  border: none !important;
  box-shadow: 0 4px 14px rgba(0, 131, 27, 0.35) !important;
}

.edhs-swal-confirm-btn:hover {
  background: linear-gradient(135deg, #00aa26 0%, #007017 100%) !important;
  transform: translateY(-2px) !important;
  box-shadow: 0 6px 20px rgba(0, 131, 27, 0.45) !important;
  color: #ffffff !important;
}

.edhs-swal-confirm-btn:active {
  transform: translateY(0) !important;
  box-shadow: 0 2px 6px rgba(0, 131, 27, 0.3) !important;
}

/* Cancel Button (Soft Neutral) */
.edhs-swal-cancel-btn {
...
.edhs-swal-cancel-btn:active {
  transform: translateY(0) !important;
}

/* Fallback for swal2-styled buttons if buttonsStyling is true */
        ...
        <script>
          ...
          $('#save').click(function () {
            ...
            const selectedMonth = $('#selectTypeOpt').val(); 
              ...
              Swal.fire({
                  ...
                  html: '<div style="font-size: 1.02rem; color: #566a7f; line-height: 1.65; margin-top: 0.25rem;">คุณต้องการบันทึกข้อมูลทะเบียนคุมลูกหนี้<br><span style="font-weight: 600; color: #00831b;">ประจำงวดเดือนนี้</span> หรือไม่?</div>',
                  icon: 'question',
                  showCancelButton: true,
                  buttonsStyling: false,
                  reverseButtons: true,
                  confirmButtonText: '<i class="bx bx-check me-1 fs-5 align-middle"></i> บันทึกข้อมูล',
                  cancelButtonText: '<i class="bx bx-x me-1 fs-5 align-middle"></i> ยกเลิก',
                  customClass: {
                      popup: 'edhs-swal-modal',
                      title: 'edhs-swal-title',
                      htmlContainer: 'edhs-swal-html',
                      actions: 'edhs-swal-actions',
                      confirmButton: 'edhs-swal-btn edhs-swal-confirm-btn',
                      cancelButton: 'edhs-swal-btn edhs-swal-cancel-btn'
                  }
              }).then((result) => {
                  if (result.isConfirmed) {
                      Swal.fire({
                          title: 'กำลังบันทึกข้อมูล...',
                          html: '<div style="font-size: 0.95rem; color: #64748b; margin-top: 0.5rem;"><i class="bx bx-loader-alt bx-spin me-1 text-primary"></i> กรุณารอสักครู่ ระบบกำลังประมวลผลข้อมูลลงฐานข้อมูล</div>',
                          allowOutsideClick: false,
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                              Swal.fire({
                                  ...
                                  html: '<div style="font-size: 1rem; color: #566a7f;">ข้อมูลทะเบียนคุมลูกหนี้ได้รับการบันทึกเรียบร้อย</div>',
                                  confirmButtonText: '<i class="bx bx-check me-1 align-middle"></i> ตกลง',
                                  buttonsStyling: false,
                                  customClass: {
                                      popup: 'edhs-swal-modal',
                                      title: 'edhs-swal-title',
                          ...
                          error: function () {
                              Swal.fire({
                                  ...
                                  html: '<div style="font-size: 0.95rem; color: #566a7f;">เกิดข้อผิดพลาดในการบันทึกข้อมูล กรุณาลองใหม่อีกครั้ง</div>',
                                  confirmButtonText: 'ตกลง',
                                  buttonsStyling: false,
                                  customClass: {
                                      popup: 'edhs-swal-modal',
                                      title: 'edhs-swal-title',
                                      confirmButton: 'edhs-swal-btn edhs-swal-cancel-btn'
                                  }
                              });
                          }
                      });
          ...
          $('#savelist').click(function () {
            ...
            data.push(rowData);
              ...
              Swal.fire({
                  title: 'ยืนยันการตั้งลูกหนี้ยกไป?',
                  html: '<div style="font-size: 1.02rem; color: #566a7f; line-height: 1.65; margin-top: 0.25rem;">คุณต้องการตั้งลูกหนี้ยกไปใช่หรือไม่</div>',
                  icon: 'question',
                  showCancelButton: true,
                  buttonsStyling: false,
                  reverseButtons: true,
                  confirmButtonText: '<i class="bx bx-check me-1 fs-5 align-middle"></i> ยืนยันข้อมูล',
                  cancelButtonText: '<i class="bx bx-x me-1 fs-5 align-middle"></i> ยกเลิก',
                  customClass: {
                      popup: 'edhs-swal-modal',
                      title: 'edhs-swal-title',
                  ...
                  if (result.isConfirmed) {
                      Swal.fire({
                          title: 'กำลังบันทึกข้อมูล...',
                          html: '<div style="font-size: 0.95rem; color: #64748b; margin-top: 0.5rem;"><i class="bx bx-loader-alt bx-spin me-1 text-primary"></i> กรุณารอสักครู่ ระบบกำลังบันทึกข้อมูล</div>',
                          allowOutsideClick: false,
                          showConfirmButton: false,
                          customClass: {
                              popup: 'edhs-swal-modal'
                      ...
                      $.ajax({
                          ...
                          success: function (response) {
                              Swal.fire({
                                  icon: 'success',
                                  title: 'บันทึกข้อมูลเรียบร้อยแล้ว',
                                  html: '<div style="font-size: 1rem; color: #566a7f;">ตั้งลูกหนี้ยกไปเรียบร้อยแล้ว</div>',
                                  showConfirmButton: false,
                                  timer: 1500,
                                  customClass: {
                                      popup: 'edhs-swal-modal'
            ...
            $('#print').click(function () {
                ...
                if (hasError) {
                    Swal.fire({
                        ...
                        text: 'กรุณากรอกข้อมูลตำแหน่ง และผู้รับผิดชอบ ให้ครบถ้วน',
      ...
      document.addEventListener("mousedown", function(e) {
        ...
        function renderAuditModalRows(accounts) {
            ...
            accounts.forEach(function(item) {
                let badgeHtml = '';
                let rowBg = '';
                let subtext = `<small class="audit-subtext">ส่งเบิกเดือนนี้: ฿${item.total_debit_fmt}</small>`;

                if (item.status === 'MATCH') {
                    if (item.is_carried_static) {
                        badgeHtml = '<span class="audit-status-badge audit-badge-match"><i class="bx bx-history me-1"></i>' + (item.status_label || 'ยอดยกมาคงเดิม (ตรงกัน 100%)') + '</span>';
                        subtext = '<small class="fw-semibold text-success"><i class="bx bx-history me-1"></i>ยอดยกมาจากเดือนก่อนหน้า ไม่มียอดเคลื่อนไหวเดือนนี้</small>';
                    } else {
                        badgeHtml = '<span class="audit-status-badge audit-badge-match"><i class="bx bx-check-circle me-1"></i>ตรงกัน 100%</span>';
                    }
                } else if (item.status === 'MISMATCH') {
                    badgeHtml = '<span class="audit-status-badge audit-badge-mismatch"><i class="bx bx-error-circle me-1"></i>' + (item.status_label || ('ต่าง ฿' + item.diff_fmt)) + '</span>';
                    rowBg = 'style="background-color: #fff5f5;"';
                } else if (item.status === 'PENDING') {
                    badgeHtml = '<span class="audit-status-badge audit-badge-pending"><i class="bx bx-time me-1"></i>' + (item.status_label || item.pending_reason || 'รอตรวจสอบยอดบัญชี') + '</span>';
                } else {
                    badgeHtml = '<span class="audit-status-badge audit-badge-inactive">ไม่มีความเคลื่อนไหว</span>';
                }

                let tr = `
                <tr ${rowBg}>
                    <td class="text-center font-monospace fw-bold text-dark" style="font-size: 12.5px !important;">${item.accountcode}</td>
                    <td class="text-start">
                        <div class="fw-bold text-dark" style="font-size: 12.5px !important;">${item.accountname}</div>
                        ${subtext}
                    </td>
                    <td class="text-end fw-bold text-dark" style="font-size: 12.5px !important;">${item.col12_fmt}</td>
                    <td class="text-end fw-bold" style="font-size: 12.5px !important;">
                        <a href="debtor_excel.php?acc=${item.accountcode}&month=${currentMonth}" target="_blank" class="fw-bold text-primary text-decoration-none" style="font-size: 12.5px !important;" title="คลิกเพื่อส่งออก Excel">
                            ฿${item.excel_total_fmt}
                        </a>
                        <div class="small fw-semibold text-secondary" style="font-size: 11px !important;">(${item.excel_count} ราย)</div>
                    </td>
                    <td class="text-end fw-bold" style="font-size: 12.5px !important;">
                        ${item.diff !== 0 ? '<span class="text-danger fw-bolder" style="font-size: 12.5px !important;">฿' + item.diff_fmt + '</span>' : '<span class="text-success fw-bolder" style="font-size: 12.5px !important;">฿0.00</span>'}
                    </td>
                    <td class="text-center">${badgeHtml}</td>
                    <td class="text-center">
                        <button type="button" class="btn btn-sm btn-outline-primary py-1 px-3 rounded-pill fw-semibold shadow-sm" style="font-size: 11.5px !important;" onclick="openReconDetail('${item.accountcode}', '${currentMonth}')" title="ตรวจหาสาเหตุ 3 มิติ">
