...
if (!function_exists('render_update_notification_banner')) {
    function render_update_notification_banner() {
        ...
        ob_start();
        ?>
        <div class="col-12 mb-4" id="edhsUpdateBanner">
          <div class="card border-0 shadow-sm" style="background: linear-gradient(135deg, #696cff 0%, #4338ca 100%); border-radius: 16px; overflow: hidden; color: #fff;">
            <div class="card-body p-4 d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
              <div class="d-flex align-items-center gap-3">
                ...
                <div>
                  <div class="d-flex align-items-center gap-2 flex-wrap mb-1">
                    ...
                    <span class="badge bg-white text-primary fw-bold rounded-pill px-2 py-1" style="font-size: 11px;">
                      v<?= $currentVer ?> &rarr; v<?= $latestVer ?>
                    </span>
                    <?php if ($relDate): ?>
                      <small class="text-white-50" style="font-size: 11.5px;"><i class="bx bx-calendar me-1"></i><?= $relDate ?></small>
                    <?php endif; ?>
                  </div>
                  <h5 class="text-white mb-1 fw-bold" style="font-size: 16px;">
                    <?= $title ?>
                  </h5>
                  <small class="text-white-50 d-block" style="font-size: 12.5px;">
                    ระบบจะสำรองไฟล์เดิมอัตโนมัติและไม่แตะต้องไฟล์คอนฟิก (config.php)
                  </small>
                </div>
              </div>
              <div class="d-flex align-items-center gap-2 flex-wrap justify-content-end">
                ...
                <button type="button" class="btn btn-warning text-dark rounded-pill px-4 py-2 fw-bold d-inline-flex align-items-center shadow" onclick="triggerSystemUpdate('<?= $latestVer ?>')" style="font-size: 13.5px; transition: transform 0.2s;">
